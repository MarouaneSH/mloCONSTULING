...
<?php echo $__env->make('layout.contact', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <div class="bg">
      ...
      <div class="caption">
         <h1 id="title" style="margin-top: 80px;font-size:60px;font-weight:bold"> Professional training 
      ...
      <div class="container">
          ...
          <div class="row">
              <p style="text-align:center;margin-left:30px;margin-bottom:200px;margin-top:20px;fon-size:16px" >
                  <br>
                        ...
                        The economic sphere changes and the leader’s priorities change as well.
          ...
          <div class="row">
                <div class="nav-services col-md-4 col-sm-5">
                        <ul id="tab-services">
                            <li class="serv-active"> <img src="<?php echo asset('img/flaticon/classroom.png'); ?>" alt=""> <span>Appointment Making </span></li>
                            <li><img src="<?php echo asset('img/flaticon/classroom.png'); ?>" alt=""><span>Sales Representatives</span></li>
