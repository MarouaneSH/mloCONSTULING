...
<?php echo $__env->make('layout.contact', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <div class="bg">
      ...
      <img src="<?php echo asset('/img/20882.jpg'); ?>" alt="" style="height: 500px;width:100%;margin-top:90px;">
      <div class="caption">
      ...
      <div class="container">
          ...
          <div class="row">
                <div class="nav-services col-md-4 col-sm-5">
                        <ul id="tab-services">
                            <li class="serv-active"> <img src="<?php echo asset('img/flaticon/classroom.png'); ?>" alt=""> <span>App Making </span></li>
