...
<link rel="stylesheet" href="<?php echo e(asset('css/AdminVisite360.css')); ?>">
...
<div class="sub-bar">
  ...
  <div class="container col-md-9">
         <div id="addTOUR">
                <form action="<?php echo e(route('addVR')); ?>" method="POST" id="formlink">
...
<script>
        ...
        //click sub nav
         ...
         $(".sub-bar li").eq(1).click(function(){
                 $(".table tbody").html('');
                 $.get("<?php echo e(route('getVR')); ?>",function(data){
         ...
         $("#search input").keyup(function(){
                 var route = "<?php echo e(route('shearchVR','')); ?>";
                 if($(this).val() == "")
                 {
