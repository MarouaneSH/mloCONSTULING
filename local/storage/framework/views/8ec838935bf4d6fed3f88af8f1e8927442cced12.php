                ...
                <div class="panel">
                    <div class="panel-header">
                            <h5>
                             ...
                             <h5>Poste : <?php echo e($demand->poste); ?>   </h5>
                             <h5>Activité : <?php echo e($demand->activite); ?>   </h5>
                             <h5>Solution : <?php echo e($demand->solution); ?>   </h5>
                     ...
                     $("#tel2").html(data.tel2);
                      $("#activite").html(data.activite);
                       ...
                       else
                       {
                           ...
                           $("#attach").attr("href", fullurl + "/document/" + fileLink );
