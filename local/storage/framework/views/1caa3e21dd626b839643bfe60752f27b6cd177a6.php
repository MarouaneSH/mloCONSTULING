             ...
             <div class="single-service">
                  <a href="<?php echo e(route('en-formation')); ?>"><img src="<?php echo asset('img/televente.jpg'); ?>" alt="" class="img-responsive">
                     <div class="service-content">
                        ...
                        <div class="services-desc">
                                <h5 style="line-height: 25px;text-align:center;font-family:Arial;margin-right: 12px;">
                                Call reception is the answering of incoming calls. It is a listening service available for customers’ requests and needs. Call reception is divided into two categories: the consumer service customer service) and the technical service (help desk)
