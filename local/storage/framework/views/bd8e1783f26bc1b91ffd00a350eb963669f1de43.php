...
<?php echo $__env->make('layout.contact', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <div class="bg">
      ...
      <img src="<?php echo asset('/img/Tvente8.jpg'); ?>" alt="" style="height: 500px;width:100%;margin-top:50px;">
      <div class="caption">
      ...
      <div class="container">
          ...
          <div class="row">
                <div class="nav-services col-md-4 col-sm-5">
                        <ul id="tab-services">
                            <li class="serv-active"> <img src="<?php echo asset('img/flaticon/target.png'); ?>" alt=""> <span>Prospection intelligente</span></li>
                            <li><img src="<?php echo asset('img/flaticon/calculator.png'); ?>" alt=""><span>Négociation personnalisée</span></li>
                            <li><img src="<?php echo asset('img/flaticon/dollar-symbol.png'); ?>" alt=""><span>Vente verrouillé</span></li>
                        </ul>
