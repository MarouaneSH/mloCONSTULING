...
<?php $__env->startSection('content'); ?>
  <div class="bg">
      ...
      <img src="<?php echo asset('/img/Tvente8.jpg'); ?>" alt="" style="height: 500px;width:100%;margin-top:90px;">
      <div class="caption">
      ...
      <div class="container">
          ...
          <div class="row">
                <div class="nav-services col-md-4 col-sm-5">
                        <ul id="tab-services">
                            <li class="serv-active"> <img src="<?php echo asset('img/flaticon/target.png'); ?>" alt=""> <span>Smart Prospection</span></li>
                            <li><img src="<?php echo asset('img/flaticon/calculator.png'); ?>" alt=""><span>Custom Negotiation</span></li>
                            <li><img src="<?php echo asset('img/flaticon/dollar-symbol.png'); ?>" alt=""><span>Locked Sales</span></li>
                        </ul>
                        <a class="btn btn-default btn-devis" href="<?php echo route('devis'); ?>"><i class="fa fa-magic left" ></i> Free Quote</a>
                </div>
                <div class="services-info col-md-8 col-sm-7">
                    <div id="services1">
                            <img src="<?php echo asset('img/flaticon/target (1).png'); ?>" width="120px" alt="">
                      ...
                      <div id="services2">
                            <img src="<?php echo asset('img/flaticon/save.png'); ?>" width="120px"  alt="">
                            <h2>Custom Negotiation</h2>
                            <p style="font-size: 15px;"> We have learned throughout our experience that negotiation can only succeed <br>if we personalize it to our prospect. </p>
                      ...
                      <div id="services3">
                            <img src="<?php echo asset('img/flaticon/shopping-bag.png'); ?>" width= "110px" alt="">
                            <h2>Locked Sales</h2>
