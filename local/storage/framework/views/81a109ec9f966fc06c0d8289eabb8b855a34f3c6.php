							  ...
							  <div class="alert alert-danger" id="errors-msg">
			                    ...
			                    <form role="form" action="<?php echo e(url('DemandeDevis')); ?>" method="POST" class="registration-form" id="form-devis" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
			                        	...
			                        	<input type="text" name="email" placeholder="Email address..." class="form-email form-control" id="form-email" value="<?php echo e(old('email')); ?>">
			                        </div>

									 <div class="form-group">
			                        	<label class="sr-only" for="form-email">Mobile Number</label>
			                        	<input type="text" name="tel1" placeholder="Mobile number..." class="form-email form-control" id="form-email" value="<?php echo e(old('tel1')); ?>">
			                        </div>
