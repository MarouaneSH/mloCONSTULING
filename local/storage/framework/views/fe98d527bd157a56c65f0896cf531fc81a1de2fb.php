...
<?php echo $__env->make('layout.contact', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <div class="container services">
     ...
     <div class="total-service">
         ...
         <div class="col-md-3 col-sm-3 col-xs-12">
             <div class="single-service">
                  <a href="<?php echo e(route('vente')); ?>"><img src="<?php echo asset('img/111.jpg'); ?>" alt="" class="img-responsive">
                        <div class="service-content">
                        <h3>Télévente</h3>
                        <div class="services-desc">
                                <h5 style="line-height: 20px; font-family: Arial; text-align: center;    padding-right: 15px;">
         ...
         <div class="col-md-3 col-sm-3 col-xs-12">
             <div class="single-service">
                  <a href="<?php echo e(route('formation')); ?>"><img src="<?php echo asset('img/televente.jpg'); ?>" alt="" class="img-responsive">
                     <div class="service-content">
   ...
   //Preload imagesavealpha
            ...
            function preload(arrayOfImages) {
                ...
                preload("http://localhost:8000/img/parc-eolienne-lrg.jpg",
                                ...
                                "<?php echo e(asset('img/Groupe-Le-Carre-commercial.jpg')); ?>",
                                "<?php echo e(asset('img/Formation-VAD.jpg')); ?>");
...
<script>
    $(document).ready(function(){
         var img1 = new Image();
         img1.src="<?php echo asset('4G.PNG'); ?>";
         img1.src="<?php echo asset('standard_tel.jpg'); ?>";
         img1.src="<?php echo asset('07782717-photo-fibre-optique.jpg'); ?>";
         img1.src="<?php echo asset('116.jpg'); ?>";
         img1.src="<?php echo asset('parc-eolienne-lrg.jpg'); ?>";
         img1.src="<?php echo asset('100.jpg'); ?>";
         img1.src="<?php echo asset('how-to-write-seo-titles-2.jpg'); ?>";
         img1.src="<?php echo asset('Formation-VAD.jpg'); ?>";
