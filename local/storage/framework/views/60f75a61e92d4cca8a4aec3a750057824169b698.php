 ...
 <div class="row top-bar">
   ...
   <div class="col-md-8 col-sm-8 info">
     <ul class="about">
        <?php if($english == true): ?>
        <li> <a  href="<?php echo e(url('en/FreeQuote')); ?>">Get Free Quote</a></li>
        <?php else: ?>
         <li> <a href="<?php echo e(url('/DemandeDevis')); ?>">Demande Devis</a></li>
        <?php endif; ?>
       ...
       <div class="col-md-2 col-sm-2">
            <div class="navbar-header">
              ...
              <!--<a class="navbar-brand" href="#"><img src="img/logo2.png" class="" style="display:inline" width="70px" alt=""></a>-->
               <?php if($english ==true): ?>
              <a href="/en"> <img src="<?php echo asset('img/logo2.png'); ?>" class="" style="display:inline" width="70px" alt="" style="margin-top: 10px;"></a>
              <?php else: ?>
                 <a href="/"> <img src="<?php echo asset('img/logo2.png'); ?>" class="" style="display:inline" width="70px" alt="" style="margin-top: 10px;"></a>
              <?php endif; ?>
            </div>
        </div>
        <div class="col-md-5 col-sm-5">
