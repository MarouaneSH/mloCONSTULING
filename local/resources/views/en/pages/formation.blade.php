...
@include('layout.contact')
  ...
  <div class="bg">
      ...
      <img src="{!! asset('/img/20882.jpg') !!}" alt="" style="height: 500px;width:100%;margin-top:50px;">
      <div class="caption">
      ...
      <div class="container">
          ...
          <div class="row">
                <div class="nav-services col-md-4 col-sm-5">
                        <ul id="tab-services">
                            <li class="serv-active"> <img src="{!!asset('img/flaticon/classroom.png')!!}" alt=""> <span>Appointment Making </span></li>
