 ...
 <div class="row top-bar">
   ...
   <div class="col-md-8 col-sm-8 info">
     <ul class="about">
        @if($english == true)
        <li> <a  href="{{url('en/FreeQuote')}}">Get Free Quote</a></li>
        @else
         <li> <a href="{{url('/DemandeDevis')}}">Demande Devis</a></li>
        @endif
       ...
       <div class="col-md-2 col-sm-2">
            <div class="navbar-header">
              ...
              <!--<a class="navbar-brand" href="#"><img src="img/logo2.png" class="" style="display:inline" width="70px" alt=""></a>-->
               @if($english ==true)
              <a href="/en"> <img src="{!! asset('img/logo2.png')!!}" class="" style="display:inline" width="70px" alt="" style="margin-top: 10px;"></a>
              @else
                 <a href="/"> <img src="{!! asset('img/logo2.png')!!}" class="" style="display:inline" width="70px" alt="" style="margin-top: 10px;"></a>
              @endif
            </div>
        </div>
        <div class="col-md-5 col-sm-5">
