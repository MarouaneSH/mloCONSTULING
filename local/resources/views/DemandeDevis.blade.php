							  ...
							  <div class="alert alert-danger" id="errors-msg">
			                    ...
			                    <form role="form" action="{{url('DemandeDevis')}}" method="POST" class="registration-form" id="form-devis" enctype="multipart/form-data">
			                    	...
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="raison" placeholder="Raison sociale..." class="form-first-name form-control" id="form-first-name" value="{{old('raison')}}">
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-last-name">Nom résponsable</label>
			                        	<input type="text" name="nom" placeholder="Nom résponsable..." class="form-last-name form-control" id="form-last-name" value="{{old('nom')}}">
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-email">Poste occupé</label>
			                        	<input type="text" name="poste" placeholder="Poste occupé..." class="form-email form-control" id="form-email" value="{{old('poste')}}">
			                        </div>
                                    <div class="form-group">
			                        	<label class="sr-only" for="form-email">Adresse Email</label>
			                        	<input type="text" name="email" placeholder="Adresse Email..." class="form-email form-control" id="form-email" value="{{old('email')}}">
			                        </div>

									 <div class="form-group">
			                        	<label class="sr-only" for="form-email">Ligne Mobile directe</label>
			                        	<input type="text" name="tel1" placeholder="Ligne Mobile directe..." class="form-email form-control" id="form-email" value="{{old('tel1')}}">
			                        </div>

									 <div class="form-group">
			                        	<label class="sr-only" for="form-email">Ligne fixe directe</label>
			                        	<input type="text" name="tel2" placeholder="Ligne fixe directe..." class="form-email form-control" id="form-email" value="{{old('tel2')}}">
			                        </div>
