  ...
  <div class="bg">
      ...
      <div class="caption">
         <h1 id="title" style="margin-top: 80px;font-size:60px;font-weight:bold"> FORMATION PROFESSIONNELLE 
              <p style="font-size:20px;font-weight:400"> <span id="cptn">MLO</span> Devient facile.</p>
        </h1>
       </div>
  </div> 
      ...
      <div class="container">
          ...
          <div class="row">
              <p style="text-align:center;margin-left:30px;margin-bottom:200px;margin-top:20px;fon-size:16px" >
                  <br>
                        ...
                        la sphère économique change et les priorités des dirigents changent aussi.
          ...
          <div class="row">
                <div class="nav-services col-md-4 col-sm-5">
                        <ul id="tab-services">
                            <li class="serv-active"> <img src="{!!asset('img/flaticon/classroom.png')!!}" alt=""> <span>Prise de RDV</span></li>
                            <li><img src="{!!asset('img/flaticon/classroom.png')!!}" alt=""><span>Commerciaux Terrain/VAD</span></li>
