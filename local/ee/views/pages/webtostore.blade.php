...
@include('layout.contact')
  <div class="bg">
      ...
      <img src="{!! asset('/img/thomas-lefebvre-3950.jpg') !!}" alt="" style="height: 500px;width:100%;margin-top:90px;">
      <div class="caption">
         <h1 id="title" style="margin-top: 80px;font-size:60px;font-weight:bold;">WEB TO STORE
             <p style="font-size:20px;font-weight: 300;"> <span id="cptn">MLO</span> Devient facile. 
             </p>
          </h1>
       </div>
  </div>
      ...
      <div class="container">
          ...
          <div class="row">
                <div class="nav-services col-md-4 col-sm-5">
                        <ul id="tab-services">
                            <li class="serv-active"> <img src="{!!asset('img/flaticon/line-chart (1).png')!!}" alt=""> <span>SEO</span></li>
                            <li><img src="{!!asset('img/flaticon/world-wide-web.png')!!}" alt=""><span>Développement web</span></li>
                            <li><img src="{!!asset('img/flaticon/mobile-app-developing (1).png')!!}" alt=""><span>Application mobile</span></li>
                        </ul>
                ...
                <div class="services-info col-md-8 col-sm-7">
                    <div id="services1">
                            <img src="{!!asset('img/flaticon/analytics.png')!!}" alt="" width="100px">
                            <h2>SEO</h2>
                      ...
                      <div id="services2">
                            <img src="{!!asset('img/flaticon/browser.png')!!}" alt="" width="100px">
                            <h2> Développement  web</h2>
                            <p style="font-size: 15px;"> 
                               Dans le secteur de l’informatique, le développeur web est un métier incontournable.
                      ...
                      <div id="services3">
                            <img src="{!!asset('img/flaticon/smartphone.png')!!}" width= "100px" alt="">
