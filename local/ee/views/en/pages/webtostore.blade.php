          ...
          <div class="row">
                <div class="nav-services col-md-4 col-sm-5">
                        <ul id="tab-services">
                            ...
                            <li><img src="{!!asset('img/flaticon/world-wide-web.png')!!}" alt=""><span>Web Development</span></li>
                            <li><img src="{!!asset('img/flaticon/mobile-app-developing (1).png')!!}" alt=""><span>Mobile Applications</span></li>
                        </ul>
