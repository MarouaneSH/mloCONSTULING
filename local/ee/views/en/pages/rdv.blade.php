...
@include('layout.contact')
  <div class="bg">
      ...
      <img src="{!! asset('/img/slider18.jpg') !!}" alt="" style="height: 500px;width:100%;margin-top:90px;">
      <div class="caption">
      ...
      <div class="container">
          ...
          <div class="row">
              <p style="text-align:center;margin-left:30px;margin-bottom:200px;margin-top:20px;fon-size:16px" >
                    ...
                    Telecommunication- IT solution:  landline and mobile phones, landline and mobile data
                    Newtechnologies:Google apps (android) and every other Google services (GoogleStreet view trusted)
                    </p>
          </div>
          <div class="row">
                <div class="nav-services col-md-4 col-sm-5">
                        <ul id="tab-services">
                            <li class="serv-active"> <img src="{!!asset('img/flaticon/calendar.png')!!}" alt=""> <span>PROSPECTING</span></li>
                            <li><img src="{!!asset('img/flaticon/clipboard.png')!!}" alt=""><span>CONFIRMATION</span></li>
                            <li><img src="{!!asset('img/flaticon/icon.png')!!}" alt=""><span>CONCRETIZATION</span></li>
                        </ul>
                ...
                <div class="services-info col-md-8 col-sm-7">
                    <div id="services1">
                            ...
                            <h2>PROSPECTING</h2>
                            <p style="font-size: 15px;">Our Team is in charge of prospecting and qualifying your appointments.</p>
                      ...
                      <div id="services2">
                            ...
                            <h2>CONFIRMATION</h2>
                             <p  style="font-size: 15px;">  We take care of your confirmations.</p>
